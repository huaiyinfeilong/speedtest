...
<head>
	...
	<title>
		<?= getenv('TITLE') ?: 'LibreSpeed Example' ?>
	</title>
</head>
...
<body onload="initServers()">
	...
	<div id="testWrapper" class="hidden">
		<div tabindex="0" role="button" id="startStopBtn" onclick="startStop()"></div>
		<?php if (getenv("TELEMETRY") == "true") { ?>
			<a class="privacy" href="#" onclick="I('privacyPolicy').style.display=''">Privacy</a>
		<?php } ?>
		<div id="serverArea">
			Server: <select aria-label="Server:" id="server"
		...
		<div id="test">
			...
			<div id="shareArea" style="display:none">
				...
				<input type="text" role="button" aria-label="Copy the link" value="" id="resultsURL" readonly="readonly"
	...
	<div id="privacyPolicy" style="display:none">
		...
		<p>
			...
			Contact this email address for all deletion requests: <a
				href="mailto:<?= getenv("EMAIL") ?>"><?= getenv("EMAIL") ?></a>.
		</p>
		<br /><br />
